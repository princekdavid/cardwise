...
class AppContainer(context: Context) {
    ...
    val cardRepository: CardRepository by lazy { RoomCardRepository(database) }
    val rewardRuleRepository: RewardRuleRepository by lazy { RoomRewardRuleRepository(database) }
    val benefitCatalogRepository: BenefitCatalogRepository by lazy { RoomBenefitCatalogRepository(database) }
}
